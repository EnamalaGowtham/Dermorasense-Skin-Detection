// Learning Hub Static Data Bundle
...
export const MYTHS_AND_FACTS = [
  ...
  {
    id: "myth_6",
    myth: "People with oily skin do not need to use moisturizer.",
    fact: "Oily skin still needs hydration. Stripping the skin of moisture can actually trigger it to produce even more oil to compensate. A lightweight, non-comedogenic moisturizer is recommended.",
  },
  {
    id: "myth_7",
    myth: "Natural skincare products are always safer and better for your skin than synthetic ones.",
    fact: "Natural ingredients can still cause allergic reactions or irritation, while many synthetic ingredients are rigorously tested for safety and efficacy. Formulations matter more than just being 'natural'.",
  },
  {
    id: "myth_8",
    myth: "People with dark skin don't need to wear sunscreen.",
    fact: "While more melanin offers some natural protection, people with dark skin can still get sunburns, premature aging, and skin cancer. Sunscreen is recommended for all skin tones.",
  },
  {
    id: "myth_9",
    myth: "Scrubbing your face frequently will clear up acne.",
    fact: "Aggressive scrubbing can irritate the skin, worsen inflammation, and damage the protective skin barrier. Gentle cleansing is much safer and more effective for acne-prone skin.",
  },
  {
    id: "myth_10",
    myth: "Applying toothpaste is a great way to dry out a pimple overnight.",
    fact: "Toothpaste contains harsh ingredients like baking soda and peroxide that can severely dry out and burn the skin. Formulated acne spot treatments are much safer and more effective.",
  },
  {
    id: "myth_11",
    myth: "Eating chocolate and greasy food is the main cause of acne.",
    fact: "While high-glycemic diets may influence breakouts in some people, chocolate and greasy foods are not the primary cause of acne. Hormones, genetics, and bacteria play a much larger role.",
  },
  {
    id: "myth_12",
    myth: "You can shrink your pores by washing your face with cold water.",
    fact: "Pores do not have muscles and cannot physically shrink or open. Cold water can temporarily reduce swelling, but pore size is largely determined by genetics and collagen levels.",
  },
  {
    id: "myth_13",
    myth: "Wearing makeup every day ages your skin faster.",
    fact: "Makeup itself doesn't cause aging. However, failing to remove it properly before bed can lead to clogged pores and irritation. Some makeup even provides additional sun protection.",
  },
  {
    id: "myth_14",
    myth: "Getting a 'base tan' prevents you from getting a sunburn later on.",
    fact: "A base tan provides an SPF of only about 3 or 4, which is not enough to protect against sun damage. Any intentional change in skin color from UV exposure indicates cellular damage.",
  },
  {
    id: "myth_15",
    myth: "Leaving a cut or wound open to the air helps it heal faster.",
    fact: "Wounds actually heal faster and with less scarring when kept moist and covered. A clean bandage and petroleum jelly create an optimal healing environment.",
  }
];
...
export const SKIN_CARE_GUIDES = [
  ...
  },
  {
    ...
    icon: "Sun",
    whatIsIt: "Protecting your skin from the sun's invisible UV rays using sunscreen and clothing.",
    whyImportant: "Sunlight can cause sunburn, early aging (like wrinkles), and increases the risk of skin cancer.",
    whatToDo: [
      "Apply sunscreen to all skin not covered by clothing.",
      "Wear a wide-brimmed hat and sunglasses.",
      "Seek shade when the sun is strongest (midday)."
    ],
    howOften: "Daily: Apply in the morning, and reapply every 2 hours if outdoors.",
    dos: [
  ...
  },
  {
    ...
    icon: "Apple",
    whatIsIt: "Eating healthy foods and drinking enough water to support your body and skin.",
    whyImportant: "Your skin needs nutrients and water from the inside to stay healthy and repair itself.",
    whatToDo: [
    ...
    howOften: "Daily.",
    tips: [
      "Keep a water bottle nearby as a reminder to drink."
    ],
    dos: [
      "Maintain a balanced diet."
    ],
    avoids: [
      "Relying on specific foods as a guaranteed cure for skin diseases."
    ]
  },
  {
    id: "guide_sleep",
  ...
  },
  {
    id: "guide_doctor",
    category: "Medical",
    title: "👨‍⚕️ When to See a Dermatologist",
    icon: "Stethoscope",
